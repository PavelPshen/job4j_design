...
class AnalizeTest {
    ...
    @Test
    void whenOneAddedAndOneDeleted() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        Set previous = Set.of(u1, u2, u3);
    ...
    @Test
    void whenOneAddedAndTwoChangedAndThreeDeleted() {
        User u1 = new User(1, "A");
        User u2 = new User(2, "B");
        User u3 = new User(3, "C");
        ...
        Set current = Set.of(new User(1, "AA"), new User(3, "CC"), new User(6, "F"));
        assertThat(Analize.diff(previous, current)).isEqualTo(new Info(1, 2, 3));
    }
}